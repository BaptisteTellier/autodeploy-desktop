...
var translations = map[string]map[string]string{
	"en": {
		...
		"admin.footer_mid":       "(persisted on disk, survives restarts). You can fetch it from GitHub (",
		...
		"admin.footer_post":      "selected to remove it and revert to the baked-in script.",
		...
		"lic.none_post":        ".",
		"lic.none_hint":        "Upload one with the button above, or copy it directly into the app's",
		...
		"wiz.help.SourceISO":                           "The Veeam Software Appliance ISO you downloaded from Veeam's website. Browse to any local ISO file, or place it in the app's data\\iso folder.",
		...
		"wiz.help.LicenseFile":                         "The .lic file to inject. Upload it via the Licenses page or place it directly in the app's data\\license folder.",
		...
		"wiz.help.RestoreConfig":                       "Restore a previously exported appliance configuration (requires conftoresto.bco placed in the app's data\\conf folder).",
		...
		"wiz.help.CFGOnly":                             "Only inject the config files without rebuilding the ISO. Useful for Packer or other tools that consume the .cfg files directly.",
	...
	"fr": {
		...
		"admin.footer_mid":       "(persisté sur disque, survit aux redémarrages). Tu peux le récupérer depuis GitHub (",
		...
		"admin.footer_post":      "sélectionné pour le supprimer et revenir au script baked-in.",
		// admin JS literals
		...
		"lic.none_post":        ".",
		"lic.none_hint":        "Uploadez-en un via le bouton ci-dessus, ou copiez-le directement dans le dossier",
		...
		"wiz.help.SourceISO":                           "L'ISO Veeam Software Appliance téléchargé depuis le site Veeam. Parcourez jusqu'à n'importe quel fichier ISO local, ou placez-le dans le dossier data\\iso de l'application.",
		...
		"wiz.help.LicenseFile":                         "Le fichier .lic à injecter. Uploadez-le via la page Licences ou placez-le directement dans le dossier data\\license de l'application.",
		...
		"wiz.help.RestoreConfig":                       "Restaurer une configuration d'appliance précédemment exportée (requiert conftoresto.bco placé dans le dossier data\\conf de l'application).",
		...
		"wiz.help.CFGOnly":                             "Injecter uniquement les fichiers de config sans reconstruire l'ISO. Utile pour Packer ou d'autres outils qui consomment directement les fichiers .cfg.",
